...
var resizePizzas = function(size) {
  ...
  // Iterates through pizza elements on the page and changes their widths
   function changePizzaSizes(size) {
    ...
    var newwidth = (document.getElementById("randomPizzaContainer").offsetWidth + dx) + 'px';
...
// variable pizzasDiv delcared outside loop, so the function only makes one DOM call
...
function updatePositions() {
  ...
  // var phase declared outside loop will prevent from being created everytime loop is executed.
  var phase;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //elem declared outside loop to prevent it from being created every time the loop is exectued.
